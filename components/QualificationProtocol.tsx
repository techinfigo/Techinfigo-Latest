                  ...
                  {[
                    ...
                    <div key={idx} className="bg-white/[0.03] border border-white/[0.05] rounded-3xl p-6 transition-all hover:bg-white/[0.06]">
                      <div className="flex items-center gap-3 mb-2">
                         <svg className="w-3.5 h-3.5 text-[#fbb632]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d={item.icon} />
                         </svg>
                         <span className="text-[8px] font-bold text-white/30 uppercase tracking-widest">{item.label}</span>
                      </div>
                      <p className="text-[11px] lg:text-[13px] font-black text-white uppercase tracking-tight">{item.val}</p>
                    </div>
                  ))}
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={idx} className="bg-white border border-black/[0.03] rounded-3xl p-6 shadow-sm">
                      <div className="flex items-center gap-3 mb-2">
                         <svg className="w-3.5 h-3.5 text-red-500/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d={item.icon} />
                         </svg>
                         <span className="text-[8px] font-bold text-black/30 uppercase tracking-widest">{item.label}</span>
                      </div>
                      <p className="text-[11px] lg:text-[13px] font-black text-[#001d1a] uppercase tracking-tight">{item.val}</p>
                    </div>
                  ))}
                </div>
              </div>
