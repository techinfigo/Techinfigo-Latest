...
export const QualificationProtocol: React.FC<QualificationProtocolProps> = ({ onBookAudit }) => {
  return (
    <section className="w-full lg:min-h-screen flex flex-col justify-center py-12 lg:py-20 px-6 bg-brandBg font-sans relative overflow-hidden">
      <div className="max-w-6xl mx-auto w-full flex flex-col justify-center h-full">
        ...
        <div className="relative rounded-[1.5rem] lg:rounded-[2rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row lg:h-[40vh] min-h-[350px] lg:min-h-[380px] bg-white ring-1 ring-black/5 animate-slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="flex-1 bg-brandDark p-5 lg:p-8 relative overflow-hidden flex flex-col group/scaler">
            {/* Background Subtle Glow */}
            <div className="absolute top-[-20%] left-[-20%] w-[70%] h-[70%] bg-brandYellow/5 rounded-full blur-[120px] pointer-events-none"></div>
            ...
            <div className="relative z-10 space-y-4 lg:space-y-6 flex-grow flex flex-col justify-between">
              <div className="space-y-1">
                ...
                <p className="text-brandYellow text-[7px] lg:text-[8px] font-black uppercase tracking-[0.25em] opacity-90">This is where real growth begins</p>
              </div>
              ...
              <div className="space-y-2 lg:space-y-3">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-2 lg:gap-3 group/item">
                    <div className="w-4 h-4 lg:w-5 lg:h-5 rounded-full bg-brandYellow/10 flex items-center justify-center shrink-0 border border-brandYellow/20">
                      <CheckCircle2 className="w-2.5 h-2.5 lg:w-3 lg:h-3 text-brandYellow" />
                    </div>
          ...
          <div className="flex-1 bg-brandBg p-5 lg:p-8 flex flex-col relative overflow-hidden group/gambler">
            <div className="relative z-10 space-y-4 lg:space-y-6 flex-grow flex flex-col justify-between">
              <div className="space-y-1">
                <h3 className="text-lg lg:text-xl font-black text-brandDark tracking-tight uppercase leading-none">Brands Still Building the Foundation</h3>
                <p className="text-brandDark/40 text-[7px] lg:text-[8px] font-black uppercase tracking-[0.25em] opacity-80">This is completely normal in early stages</p>
              </div>
              ...
              <div className="space-y-2 lg:space-y-3">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-2 lg:gap-3">
                    <div className="w-1 h-1 lg:w-1.5 lg:h-1.5 rounded-full bg-brandDark/20 shrink-0"></div>
                    <span className="text-brandDark/60 text-[10px] lg:text-sm font-medium">{point}</span>
                  </div>
                ))}
              </div>

              <div className="pt-3 border-t border-black/5">
                <p className="text-brandDark/50 text-xs lg:text-sm font-bold italic leading-relaxed">
        ...
        <div className="mt-4 text-center animate-slide-up" style={{ animationDelay: '0.15s' }}>
          <p className="text-brandDark/30 text-[9px] lg:text-[11px] font-bold uppercase tracking-[0.2em]">
        ...
        <div className="mt-6 lg:mt-8 text-center space-y-2 lg:space-y-3 animate-slide-up" style={{ animationDelay: '0.2s' }}>
          <div className="relative inline-block group">
            ...
            <button 
              onClick={onBookAudit}
              className="relative px-6 lg:px-8 py-2.5 lg:py-3.5 bg-brandDark text-white font-black text-[10px] lg:text-[12px] uppercase tracking-[0.2em] rounded-xl hover:bg-brandYellow hover:text-brandDark transition-all duration-500 shadow-xl hover:-translate-y-1 flex items-center justify-center gap-2"
            >
              Check My Growth Stage
              <ArrowRight className="w-3.5 h-3.5" />
            </button>
          </div>
          <p className="text-brandDark/40 text-[8px] lg:text-[10px] font-bold uppercase tracking-widest">
