    ...
    <section className="w-full bg-[#faf6ed] py-24 lg:py-48 px-4 sm:px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20 lg:mb-40">
          <span className="text-[9px] lg:text-[10px] font-bold tracking-[0.5em] uppercase text-brandDark/30 mb-6 block">Engine Architecture</span>
        ...
        <div className="relative py-12 lg:pt-32 lg:pb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 relative">
            {steps.map((step, index) => (
              <div key={step.id} className="relative group border-l lg:border-l-0 border-brandDark/10 pl-8 lg:pl-0">
                
                <div className="hidden lg:flex absolute top-[50%] left-0 -translate-y-[50%] z-20 items-center justify-center">
                  <div className="w-4 h-4 rounded-full bg-brandBg border-2 border-brandDark/20 group-hover:bg-brandYellow transition-all duration-500"></div>
                </div>
                ...
                `}>
                  <span className="text-4xl lg:text-6xl font-light text-brandDark/5 tracking-tighter mb-4">
                    {step.id}
                  </span>
                  <h3 className="text-3xl lg:text-4xl font-bold text-brandDark mb-4 tracking-tighter leading-none group-hover:text-brandYellow transition-colors">
                    {step.title}
                  </h3>
                  <p className="text-brandDark/60 text-base lg:text-lg leading-relaxed mb-6">
                    {step.desc}
                  </p>
                  <div className="inline-flex items-center gap-2 px-3 py-1.5 border border-brandDark/5 rounded-full w-fit bg-white/50">
                    <span className="text-[9px] lg:text-[11px] font-bold text-brandDark uppercase tracking-[0.2em]">
                      {step.variable}
                    </span>
                  </div>
                </div>
        ...
        <div className="mt-24 lg:mt-48 pt-12 border-t border-brandDark/5 flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12">
          <p className="text-brandDark/30 text-[9px] lg:text-[11px] font-mono leading-loose tracking-widest uppercase">
            CORE_PROTOCOL: LINEAR_COMPOUND_V3<br />
            DEPLOY_STATUS: FULL_SYNC
          </p>
          
          <div className="w-full lg:w-auto bg-brandDark text-white p-8 lg:p-10 rounded-sm flex flex-col sm:flex-row items-center gap-8 lg:gap-16 shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex flex-col text-center sm:text-left">
              ...
              <span className="text-4xl lg:text-5xl font-bold tracking-tighter">1.8x <span className="text-lg opacity-30">/ MO</span></span>
            </div>
          </div>
        </div>
      </div>
